							...
							<label for="">Enter choice for City:</label>
								<?php
									...
									echo "<select name=\"cityarr[]\" >";
										...
										$getcities = "select wtID, cityName from db_project.city";
...
<?php
            ...
            /*
				...
				echo "<div class=\"row\">";
				echo "<div class=\"col-md-6\" ><p align =\"center\" style = \"padding:10px 0px 10px 0px\">UserName : $uname</p></div>";
            ...
            if(!isset($tuple)){
                ...
                if($n > 1){
                ...
                else if($n==1 && ($_SESSION['city']=="ALL" || !(isset($_SESSION['city'])))){//one of the choices selected
                    if($tuple[0] == "RatingUp"){
					...
					else if($n==1 && (isset($_SESSION['city']))){
						if($tuple[0] == "RatingUp"){
